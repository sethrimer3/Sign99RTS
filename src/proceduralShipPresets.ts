...
export const SHIP_PRESETS: { name: string; def: ProceduralShipDefinition }[] = [
  {
    ...
    def: {
      ...
      params: p({
        ...
        wingPairs: 1, wingStation: 0.42, wingSweep: 0.12, wingChord: 0.3, wingSpan: 0.12, wingDetail: 3,
        finCount: 2, finLength: 0.2, finSpread: 0.14,
        shadeDepthMix: 0.3, hueSpread: 38, accentAmount: 0.65, coreSize: 0.06,
      }),
    },
  },
  {
    ...
    def: {
      ...
      params: p({
        ...
        budCount: 5, budScale: 0.2, budFalloff: 2.1, budTwist: 0.62, budDepth: 2, budEmbed: 0.5,
        wingPairs: 1, wingStation: 0.46, wingSweep: 0.18, wingChord: 0.22, wingSpan: 0.16, wingDetail: 3,
  ...
  },
  {
    ...
    def: {
      ...
      params: p({
        ...
        wingPairs: 1, wingStation: 0.5, wingSweep: 0.1, wingChord: 0.26, wingSpan: 0.2, wingDetail: 3,
  ...
  },
  {
    ...
    def: {
      ...
      params: p({
        ...
        wingPairs: 1, wingStation: 0.55, wingSweep: 0.2, wingChord: 0.22, wingSpan: 0.3, wingDetail: 3,
        finCount: 1, finLength: 0.18, finSpread: 0.08,
        shadeDepthMix: 0.28, hueSpread: 26, accentAmount: 0.8, coreSize: 0.05,
      }),
    },
  },
  {
    ...
    def: {
      ...
      params: p({
        ...
        wingPairs: 2, wingStation: 0.3, wingSweep: 0.14, wingChord: 0.26, wingSpan: 0.1, wingDetail: 3,
        finCount: 3, finLength: 0.2, finSpread: 0.3,
        shadeBands: 8, shadeDepthMix: 0.3, hueSpread: 44, accentAmount: 1, coreSize: 0.095,
      }),
    },
  },
  {
    ...
    def: {
      ...
      params: p({
        ...
        wingPairs: 1, wingStation: 0.62, wingSweep: 0.1, wingChord: 0.18, wingSpan: 0.45, wingDetail: 3,
        finCount: 2, finLength: 0.16, finSpread: 0.12,
        shadeDepthMix: 0.34, hueSpread: 32, accentAmount: 0.75, coreSize: 0.04,
      }),
    },
  },
];

...
const SHAPES: ReadonlyArray<{ name: string; seed: number; params: Partial<ProceduralShipParams> }> = [
  { name: 'Lance', seed: 1101, params: { spanToLength: 0.55, wingPairs: 2, wingElements: 2, wingSpan: 0.3, finCount: 2 } },
  { name: 'Manta', seed: 2207, params: { spanToLength: 1.5, wingPairs: 2, wingElements: 1, wingSpan: 0.48, wingSweep: 0.35, finCount: 0 } },
  { name: 'Trident', seed: 3313, params: { spanToLength: 0.7, wingPairs: 2, wingElements: 1, wingStation: 0.5, wingGroupGap: 0.22, wingRake: 0.85, wingSpan: 0.36, finCount: 1 } },
  { name: 'Arrow', seed: 4421, params: { spanToLength: 0.42, wingPairs: 2, finCount: 2, finLength: 0.36, budCount: 2, budScale: 0.08 } },
  { name: 'Crescent', seed: 5527, params: { spanToLength: 1.1, wingPairs: 2, wingElements: 1, wingRake: 1, wingSpan: 0.6, wingSweep: -0.08, finCount: 0 } },
  ...
  { name: 'Spindle', seed: 7741, params: { spanToLength: 0.45, wingPairs: 2, finCount: 0, budCount: 6, budScale: 0.2, budTwist: 0.65 } },
  { name: 'Crown', seed: 8849, params: { spanToLength: 0.95, wingPairs: 2, wingElements: 1, wingStation: 0.42, wingGroupGap: 0.16, wingSpan: 0.36, wingRake: 0.65, finCount: 4 } },
];
